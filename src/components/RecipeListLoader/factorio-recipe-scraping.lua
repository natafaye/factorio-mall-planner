...
for a, b in pairs(game.recipe_prototypes) do
    item = '{ "name": "' .. b.name .. '", "order": "' .. b.order .. '", "subgroup": "' .. b.subgroup.order .. 
    '", "group": "' .. b.group.name .. '", "category": "' .. b.category .. '", "products": ['
    productlist = {}
...
for a, b in pairs(game.item_prototypes) do
    item = '{ "name": "' .. b.name .. '", "order": "' .. b.order .. '", "subgroup": "' .. b.subgroup.order .. 
    '", "group": "' .. b.group.name .. '", "stackSize": ' .. b.stack_size .. ', "type": "'
    if b.place_result ~= nil then
        item = item .. b.place_result.type .. '", "tileWidth": ' .. b.place_result.tile_width .. 
        ', "tileHeight": ' .. b.place_result.tile_height
...
if b.place_result.type == "electric-pole" then
    pole = b.place_result
    item = item .. '"supplyAreaDistance": ' .. pole.supply_area_distance .. ', "maximumWireDistance": ' 
    .. pole.maximum_wire_distance
elseif b.place_result.type == "roboport" then
    roboport = b.place_result
    item = item .. '"logisticsRadius": ' .. roboport.logistics_radius
end